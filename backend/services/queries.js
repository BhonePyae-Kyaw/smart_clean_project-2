...
const addemail =
  "insert into customer (customer_email,customer_name,customer_number,password,customer_address) values ($1,$2,$3,$4,$5)";
...
const updatecusinfo =
  "update customer set customer_name=$1::text,customer_number = $2::text, customer_address=$3::text where customer_id=$4::integer";
